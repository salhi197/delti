                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <br>
                                    <form method="post" action="{{route('user.create',['type'=>'type'])}}" class="needs-validation" >
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="secteur" class="form-control select2" id="validationCustom03" required>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="administartion" class="form-control select2" id="validationCustom03" required>
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="denomination" type="text" class="form-control" 
                                                        required>
                                                        <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="wilaya" class="form-select" id="validationCustom03" required>
                                                        <option selected disabled value="">Séléctionner</option>
