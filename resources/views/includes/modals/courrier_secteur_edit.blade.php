<div id="myModalCS{{$cs->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <form method="post" action="{{route('courrier.update',['courrier'=>$cs->id,'source'=>'secteur'])}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select value="{{$cs->secteur_cc ?? ''}}" value="{{$cs->secteur_cc ?? ''}}"  name="secteur_cc_edit" id="secteur_cc" class="form-control ">
                    ...
                    <div class="col-md-6">
                        ...
                        <select value="{{$cs->etat_courrier_cs ?? ''}}" value="{{$cs->etat_courrier_cs ?? ''}}"  name="etat_courrier_cs_edit" id="etat_courrier_cs" class="form-control ">
                            <option value="">Séléctionner</option>  
                ...
                <div class="row">
                    <!-- <div class="col-md-6">
                            ...
                            <input value="{{$cs->piece_cc ?? ''}}"   name="piece_cc_edit" type="date" class="form-control"   >
                    </div> -->
                    <div class="col-md-6">

                            <label for="validationCustom05" class="form-label">Date  : </label>
                            <input value="{{$cs->envoi ?? ''}}"   name="date_envoi_cs_edit"  max="{{date('Y-m-d')}}"  type="date" class="form-control"   >
                    </div>
                </div>
                                <div class="row">                        
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <option value="" > -- Séléctionner-- </option>
                                                ...
                                                @foreach($secteurs as $secteur)
                                                    <option @if($cs->secteur == $secteur->id) selected @endif value="{{$cs->id}}" id="{{$cs->type}}" >
                                                        {{$secteur->type ?? ''}}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6" id="administrationdiv3">
                                        <div class="mb-3">
                                            ...
                                            <select value="{{$cs->administration_cs ?? ''}}"  name="administration_cs_edit" id="administration3" class="form-select "  >
                                                <option value="" > -- Séléctionner-- </option>
                                                @foreach($secteurs as $secteur)
                                                        <optgroup label="{{$cs->type}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" id="sousadministrationdiv3">
                                                <div class="mb-3">
                                                    ...
                                                    <select value="{{$cs->administration_cs ?? ''}}"  name="sousadministration_cs_edit" id="sousadministration3" class="form-select "  >
                                                        <option value="" > -- Séléctionner-- </option>
                    ...
                    <div class="col-md-12">
                        <div class="col-12">
                            ...
                            <input value="{{$cs->piece_cs ?? ''}}" value="{{$cs->piece_cs ?? ''}}"  name="piece_cs_edit" type="file" class="form-control"   >
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="message_cs_edit">{{$cs->message}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-12">
