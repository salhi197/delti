                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="needs-validation" method="post" action="{{route('axe.store')}}" novalidate>
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select value="{{$requete->user ?? ''}}" name="sujet" class="form-select ">
                                                                        <option value="">Séléctionner</option>  
                                                                        @foreach ($sujetrequetes as $sujetrequete)
                                                                                <option value="{{$sujetrequete->id}}" >{{$sujetrequete->type}}</option>
                                                                            @endforeach
                                                                    </select>
                                                                </div>   
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            ...
                                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#firstmodal{{$axe->id}}"> <i class=" fas fa-pen"></i></button>              
                                                            <div class="modal fade" id="firstmodal{{$axe->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="needs-validation" method="post" action="{{route('axe.update',['axe'=>$axe->id])}}" novalidate>
                                                                            @csrf
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom02" class="form-label">Numéro : </label>
                                                                                        <input type="text" value="{{$axe->numero ?? ''}}"  name="numero_edit" class="form-control" id="validationCustom02" placeholder=""  required>
                                                                                    </div>
                                                                                </div>

                                                                                <div class="col-md-6">
                                                                                    <label for="validationCustom05" class="form-label">Sujet requete :</label>
                                                                                        <select value="{{$requete->user ?? ''}}" name="sujet_edit" class="form-select ">
                                                                                            <option value="">Séléctionner</option>  
                                                                                            @foreach ($sujetrequetes as $sujetrequete)
                                                                                                    <option value="{{$sujetrequete->id}}"
                                                                                                    @if($sujetrequete->id == $axe->sujet) selected @endif
                                                                                                    >{{$sujetrequete->type}}</option>
                                                                                                @endforeach
                                                                                        </select>
                                                                                </div>   
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                        <div class="mb-3">
                                                                                            <label for="validationCustom02" class="form-label">Nom en Arabe : </label>
                                                                                            <input type="text"   value="{{$axe->type_ar ?? ''}}" name="type_ar_edit" class="form-control" id="validationCustom02" placeholder=""  required>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div class="mb-3">
                                                                                            <label for="validationCustom02" class="form-label">Nom en Anglais : </label>
                                                                                            <input type="text"   value="{{$axe->type_en ?? ''}}" name="type_en_edit" class="form-control" id="validationCustom02" placeholder=""  required>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div class="mb-3">
                                                                                            <label for="validationCustom02" class="form-label">Nom en français :</label>
                                                                                            <input type="text"  value="{{$axe->type ?? ''}}" name="type_edit" class="form-control" id="validationCustom02" required>
                                                                                        </div>
                                                                                    </div>
                                                                            </div>
                                                            ...
                                                            <a href="{{route('axe.destroy',['id_axe'=>$axe->id])}}"
                                    ...
                                    <label for="" class="form-label">Total : {{count($axes)}}</label>
