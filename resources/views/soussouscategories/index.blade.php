                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="needs-validation" method="post" action="{{route('soussouscategorie.store')}}" novalidate>
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                    ...
                                    <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            @foreach($soussouscategories as $soussouscategorie)
                                                <tr>
                                                    <td>{{$soussouscategorie->id ?? ''}}</td>
                                                    <td>{{$soussouscategorie->categorie() ?? ''}}</td>
                                                    <td>{{$soussouscategorie->label ?? ''}}</td>

                                                    <td>
                                                        <div class="table-action">

                                                            <a href="{{route('soussouscategorie.destroy',['id_soussouscategorie'=>$soussouscategorie->id])}}"
                                                                onclick="return confirm('etes vous sure  ?')" class="text-white btn btn-danger">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                                                                                      
                                                            <div class="modal fade" id="exampleModal{{$soussouscategorie->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="needs-validation" method="post" action="{{route('soussouscategorie.update',['soussouscategorie'=>$soussouscategorie->id])}}" novalidate>
                                                                            @csrf
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom01" class="form-label">Numéro</label>
                                                                                        <input type="text"  value="{{$soussouscategorie->numero ?? ''}}" name="numero" class="form-control" id="validationCustom01" placeholder="" value="" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom02" class="form-label">Type</label>
                                                                                        <input type="text"   value="{{$soussouscategorie->type ?? ''}}" name="type" class="form-control" id="validationCustom02" placeholder="" value="" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </form>
