                                            ...
                                            <h6>Information Requete : </h6>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class=" select2 form-select" name="source" id="source"  required>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="col-12">
                                                            ...
                                                            <input name="numero" onKeyPress="if(this.value.length==5) return false" required type="number" class="form-control"  id="numero" required>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="type_requete" class="form-select select2" id="typerequete" required>
                                                    <option value="" > -- Séléctionner-- </option>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="titre" type="text" class="form-control" id="validationCustom05"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="video" type="text" class="form-control" id="validationCustom05"
                                                        >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="mb-3">
                                                                                            ...
                                                                                            <input type="date" max="{{date('Y-m-d')}}" class="form-control" name="date_audience" id="validationCustom05"
                                                                                                required>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-6">
