            ...
            <div class="row">
              <div class="col-md-3">
                <div class="mb-3">
                  ...
                  <select name="secteur" class="form-control select2" id="inputState" required>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  ...
                  <input name="activite" type="text" class="form-control" id="validationCustom05" required />
                </div>
              </div>
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="validationCustom02" class="form-label">Implimentation</label>
                  <select name="implimentation" class="form-control select2" id="validationCustom03" required>
                    <option selected>Sélectionner...</option>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  ...
                  <input name="Superficie" type="number" class="form-control" id="validationCustom05" required />
                </div>
                <br />
              </div>
            </div>
            ...
            <div class="row" id="fiche1">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="date" max="{{date('Y-m-d')}}" name="date_projet_exploitation" class="form-control"
                    placeholder="">
                </div>
              </div>
              <div class="col-md-4">
