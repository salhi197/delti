                                        ...
                                        <div class="row">
                                            <h6><b>Informations doleance : </b></h6>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="datedoleance" id="date_doleance" type="date" max="{{date('Y-m-d')}}"  class="form-control" 
                                                            value="Mark" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a href="{{route('client.show.create')}}" class="btn btn-primary" type="button" style="background-color:#009640; border-style:none;""><i class="fa fa-plus"></i></a>
                                                    </span>
                                                </div>                                                
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <option value="" > -- Séléctionner-- </option>
                                                        ...
                                                        @foreach ($typedoleances as $typedoleance)
                                                            <option value="{{$typedoleance->id}}" id="{{$typedoleance->type ?? ''}}" >{{$typedoleance->type ?? ''}}</option>
                                                        @endforeach
                                                    </select>                                                    
