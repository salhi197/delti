...
@section('styles')
    <link rel="stylesheet" href="{{asset('cirm/admin/assets/libs/@fullcalendar/core/main.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('cirm/admin/assets/libs/@fullcalendar/daygrid/main.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('cirm/admin/assets/libs/@fullcalendar/bootstrap/main.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('cirm/admin/assets/libs/@fullcalendar/timegrid/main.min.css')}}" type="text/css">

@endsection
@section('scripts')

    <script src="{{asset('cirm/admin/assets/libs/moment/min/moment.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/jquery-ui-dist/jquery-ui.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/@fullcalendar/core/main.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/@fullcalendar/bootstrap/main.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/@fullcalendar/daygrid/main.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/@fullcalendar/timegrid/main.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/@fullcalendar/interaction/main.min.js')}}"></script>

    <script src="{{asset('cirm/admin/assets/js/pages/calendar.init.js')}}"></script>
