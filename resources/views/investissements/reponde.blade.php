    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="form_layouts.html"><img alt="logo" src="{{asset('cirm/admin/invest/assets/img/logo-sm.png')}}"> <span class="navbar-brand-name">Wassit</span></a>
            </div>
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                <li class="nav-item dropdown language-dropdown more-dropdown">
                    <div class="dropdown custom-dropdown-icon">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('cirm/admin/invest/assets/img/flag-fr.svg')}} " class="flag-width" alt="flag"><span>Français</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <form action="{{route('investissement.repondre',['investissement'=>$investissement->id])}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="container" id="fiche3">
                                    ...
                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                        <label>Pièce jointe :{{$investissement['piece_jointe']}}
                                             <a href="{{asset($investissement->piece_jointe)}}" class="custom-file-container__image-clear" title="Clear Image"></a>
                                        </label>
