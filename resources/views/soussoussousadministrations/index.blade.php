                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            ...
                                                            <a href="{{route('sousadministration.destroy',['id_sousadministration'=>$sousadministration->id])}}"
                                                                onclick="return confirm('etes vous sure  ?')" class="text-white btn btn-danger">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                                                                                      
                                                            
                                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#firstmodal{{$sousadministration->id}}"> Modifier sousadministration</button>
                                                            <div class="modal fade" id="firstmodal{{$sousadministration->id}}" aria-hidden="true" aria-labelledby="" tabindex="-1">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">+ Ajouter sous administration</h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form class="needs-validation" method="post" action="{{route('sousadministration.update',['sousadministration'=>$sousadministration->id])}}" novalidate>
                                                                                @csrf
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="mb-3">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div class="mb-3">
                                                                                            <label for="validationCustom02" class="form-label">Type</label>
                                                                                            <input type="text"   name="label" class="form-control" id="validationCustom02" placeholder="" value="{{$sousadministration->label}}" required>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <button class="btn btn-primary" data-bs-target="#secondmodal" data-bs-toggle="modal" data-bs-dismiss="modal">Sauvegarder</button>
