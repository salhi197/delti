                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="needs-validation" method="post" action="{{route('etatrequete.store')}}" >
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            @foreach($etatrequetes as $etatrequete)
                                                <tr>
                                                    <td>{{$etatrequete->id ?? ''}}</td>
                                                    <td>{{$etatrequete->type ?? ''}}</td>
                                                    <td>{{$etatrequete->categorie() ?? ''}}</td>
                                                    <td>{{$etatrequete->souscategorie() ?? ''}}</td>
                                                    <td>
                                                        <div class="table-action">

                                                            <a href="{{route('etatrequete.destroy',['id_etatrequete'=>$etatrequete->id])}}"
                                                                onclick="return confirm('etes vous sure  ?')" class="text-white btn btn-danger">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{$etatrequete->id}}">
                                                                Modifier
                                                            </button>
                                                                                                                      
                                                            <div class="modal fade" id="exampleModal{{$etatrequete->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="needs-validation" method="post" action="{{route('etatrequete.update',['etatrequete'=>$etatrequete->id])}}" novalidate>
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom01" class="form-label">Numéro</label>
                                                                                        <input type="text"  value="{{$etatrequete->numero ?? ''}}" name="numero" class="form-control" id="validationCustom01" placeholder="" value="" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom02" class="form-label">Type</label>
                                                                                        <input type="text"   value="{{$etatrequete->type ?? ''}}" name="type" class="form-control" id="validationCustom02" placeholder="" value="" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </form>
