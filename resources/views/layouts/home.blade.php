                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="plaint.html">
                                            <img src="{{asset('cirm/admin/assets/images/brands/plaint.png')}}" alt="Paramètres">
                                            <span>Plainte</span>
                                        </a>
                                    </div>
                                    <!--
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="{{route('etatrequete.index')}}">- Etats de Requetes</a></li>
                                <li><a href="{{route('categorie.index')}}">- Categories</a></li>
                                <li><a href="{{route('souscategorie.index')}}">- Sous Categories</a></li>
                                <li><a href="{{route('axe.index')}}">- Axe </a></li>
                            </ul>
                        </li>
