            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <!-- <div class="dropdown dropdown-mega d-none d-lg-block ms-2">
                        <img src="{{asset('client/assets/images/wassit.png')}}" alt="logo-light" height="40" style="margin: 20px;">
                    </div> -->
                </div>
...
-->
    ...
    <!-- apexcharts -->
    <script src="{{asset('client/assets/libs/apexcharts/apexcharts.min.js')}}"></script>
