...
@section('script')
    ...
    <!-- Buttons examples -->
    <script src="{{asset('cirm/admin/assets/libs/datatables.net-buttons/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/jszip/jszip.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/pdfmake/build/pdfmake.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/pdfmake/build/vfs_fonts.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/datatables.net-buttons/js/buttons.html5.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/datatables.net-buttons/js/buttons.print.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/datatables.net-buttons/js/buttons.colVis.min.js')}}"></script>

    <script src="{{asset('cirm/admin/assets/libs/datatables.net-keytable/js/dataTables.keyTable.min.js')}}"></script>
    <script src="{{asset('cirm/admin/assets/libs/datatables.net-select/js/dataTables.select.min.js')}}"></script>
    ...
    <!-- Datatable init js -->
    <script src="{{asset('cirm/admin/assets/js/pages/datatables.init.js')}}"></script>
