                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                        <div class="row">
                                            <h6><b>Informations doleance : </b></h6>
                                                <hr>
                                                <div class="col-6">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="datedoleance" id="date_doleance" type="date" max="<?php echo e(date('Y-m-d')); ?>"  class="form-control" 
                                                            value="Mark" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a href="<?php echo e(route('client.show.create')); ?>" class="btn btn-primary" type="button" style="background-color:#009640; border-style:none;""><i class="fa fa-plus"></i></a>
                                                    </span>
                                                </div>                                                
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <label for="validationCustom04" class="form-label"> Etat doléance </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="validationCustom02" class="form-label">Wilaya</label>
                                                    <br>
                                                    <select disabled class=" select2 form-control" id="wilaya"  name="wilaya">
                                                        <option value="" > -- Séléctionner-- </option>
                                                        <?php $__currentLoopData = $wilayas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wilaya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <option value="" > -- Séléctionner-- </option>
                                                        ...
                                                        <?php $__currentLoopData = $typedoleances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typedoleance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($typedoleance->id); ?>" id="<?php echo e($typedoleance->type ?? ''); ?>" ><?php echo e($typedoleance->type ?? ''); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>                                                    
...
-->
                                            <div class="col-md-6" id="secteurdiv">
                                                <div class="mb-3">
                                                    <label for="validationCustom02" class="form-label">Secteur</label>
                                                    <select class="form-control" name="secteur_officiel" id="secteur">
                                                    <option value="" > -- Séléctionner-- </option>
                                        ...
                                        <div class="modal-footer">
                                                ...
                                                <button class="btn btn-primary" type="submit" style="background-color:#009640; border-style:none;"><i class="fas fa-save"></i> Sauvegarder</button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div>
                                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#firstmodal" style="margin-left: -20px; background-color:#009640; border-style:none;"><i class=" fas fa-plus-circle" ></i></button>
                                                                <!-- First modal dialog -->
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="post" id="myForm" action="<?php echo e(route('audience.store')); ?>" class="needs-validation" enctype="multipart/form-data">    
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-6" >
                                                                                            <label for="validationCustom02" class="form-label">Secteur</label>
                                                                                            <select class="form-control" name="secteure2" id="secteurelt2">
                                                                                                <option value="">
                                                                                                    Séléctionner
                                                                                                </option>
                                                                                                <?php $__currentLoopData = $secteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secteur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <button class="btn btn-primary" id="submit" style="background-color:#009640; border-style:none;"> Sauvegarder </button>
                                                                                    </div>
                                                                                </form>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModalcc" style="background-color:#009640; border-style:none;"><i class=" fas fa-plus-circle"></i> </button>
                                        </div>
                                        <br>
                                        ...
                                        <div class="col-md-2">
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModalCS" style="background-color:#009640; border-style:none;"><i class=" fas fa-plus-circle"></i></button>
                                            </div>
                                        <br>
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        <div class="tab-pane active" id="home1" role="tabpanel">
                                            ...
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModalAttr"style="background-color:#009640; border-style:none;"><i class=" fas fa-plus-circle"></i> </button>
                                            </div>
                                            <br>
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                        ...
                                        <div class="tab-pane" id="profile1" role="tabpanel">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModalTrans"style="background-color:#009640; border-style:none;"><i class=" fas fa-plus-circle"></i></button>
                                            </div>
                                            <br>
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                        ...
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModalEx"style="background-color:#009640; border-style:none;"><i class=" fas fa-plus-circle"></i></button>
                                        </div>
                                        <br>
