                            ...
                            <div class="card-body"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="home-1" role="tabpanel">
                                        <form method="post" action="<?php echo e(route('doleance.store.client')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <option value="" > -- Séléctionner-- </option>
                                                            <?php $__currentLoopData = $sujetdoleances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sujetdoleance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($sujetdoleance->id); ?>" id="<?php echo e($sujetdoleance->type ?? ''); ?>" ><?php echo e($sujetdoleance->type ?? ''); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>                                                    
