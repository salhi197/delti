                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="needs-validation" method="post" action="<?php echo e(route('sujetdoleance.store')); ?>" novalidate>
                                                            <?php echo csrf_field(); ?>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        <label for="validationCustom02" class="form-label">Type doleance</label>
                                                                        <select class="form-control" name="typedoleance">
                                                                            <?php $__currentLoopData = $typedoleances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typedoleance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($typedoleance->id); ?>">
                                                                                    <?php echo e($typedoleance->type ?? ''); ?>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $sujetdoleances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sujetdoleance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($sujetdoleance->numero ?? $sujetdoleance->Numero); ?></td>
                                                    <td><?php echo e($sujetdoleance->type ?? ''); ?></td>
                                                    <td><?php echo e($sujetdoleance->secteur() ?? ''); ?></td>
                                                    <td><?php echo e($sujetdoleance->administration() ?? ''); ?></td>
                                                    <td><?php echo e($sujetdoleance->typedoleance() ?? ''); ?></td>
                                                    <td>
                                                        <div class="table-action">


                                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo e($sujetdoleance->id); ?>">
<i class=" fas fa-pen"> </i>                                                            </button>
                                                                                                                      
                                                            <div class="modal fade" id="exampleModal<?php echo e($sujetdoleance->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="needs-validation" method="post" action="<?php echo e(route('sujetdoleance.update',['sujetdoleance'=>$sujetdoleance->id])); ?>" novalidate>
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom01" class="form-label">Numéro :</label>
                                                                                        <input type="text"  value="<?php echo e($sujetdoleance->numero ?? ''); ?>" name="numero_edit" class="form-control" id="validationCustom01" placeholder="" value="" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom02" class="form-label">Nom en arabe :</label>
                                                                                        <input type="text"   value="<?php echo e($sujetdoleance->type_ar ?? ''); ?>" name="type_ar_edit" class="form-control" id="validationCustom02" placeholder="" value="" required>
                                                                                </div>
                                                                                </div> 
                                                                                                                                                                <div class="col-md-6">
                                                                                <div class="mb-3">
                                                                                        <label for="validationCustom02" class="form-label">Nom en anglais : </label>
                                                                                        <input type="text"   value="<?php echo e($sujetdoleance->type_en ?? ''); ?>" name="type_en_edit" class="form-control" id="validationCustom02" placeholder="" value="" required>
                                                                                </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="validationCustom02" class="form-label">Nom en français</label>
                                                                                        <input type="text"   value="<?php echo e($sujetdoleance->type ?? ''); ?>" name="type_edit" class="form-control" id="validationCustom02" placeholder="" value="" required>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-light waves-effect" data-bs-dismiss="modal">Fermer</button>
                                                            ...
                                                            <a href="<?php echo e(route('sujetdoleance.destroy',['id_sujetdoleance'=>$sujetdoleance->id])); ?>"
