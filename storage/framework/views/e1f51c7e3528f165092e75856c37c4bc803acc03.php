                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <br>
                                    <form class="needs-validation" novalidate method="post" action="<?php echo e(route('role.store')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-check mb-12">
                                                                <input class="form-check-input" name="create_<?php echo e($pr); ?>" type="checkbox" id="formCheck1">
                                                                <label class="form-check-label" >
                                                                    Créer
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" name="read_<?php echo e($pr); ?>" type="checkbox"  >
                                                                <label class="form-check-label" for="formCheck2">
                                                                    Lire
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input   class="form-check-input" name="delete_<?php echo e($pr); ?>" type="checkbox" >
                                                                <label class="form-check-label" for="formCheck2">
                                                                    Supprimer
                                                                </label>
                                                            </div>
