...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('cirm2/ar/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" />

        <link href="<?php echo e(asset('cirm2/ar/assets/css/plugins.css')); ?>" rel="stylesheet" type="text/css" />
                            ...
                            <form action="<?php echo e(route('investissement.create')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row mb-4">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="telephone" required type="number" class="form-control" id="inputEmail4" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="inputPassword4">الفاكس</label>
                                        <input name="fax" type="number" class="form-control" id="inputPassword4" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="inputPassword4">الجوال</label>
                                        <input name="mobile" type="number"  class="form-control" id="inputPassword4" placeholder="">
                                    </div>
                                    <div class="form-group col-md-3">
                                ...
                                <div class="container-fluid" id="fiche1">
                                    ...
                                    <div class="form-row mb-4">                                        
                                        ...
                                        <div id="date_projetexploitation" class="form-group col-md-4" >
                                            ...
                                            <input type="date" max="<?php echo e(date('d-m-Y')); ?>" name="date_projet_exploitation" class="form-control"  placeholder="">
                                        </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_permisconstruction" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_permis_construction" class="form-control"  placeholder="">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div id="date_arretcreation" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_arret_creation" class="form-control"  placeholder="">
                                        </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_approbation" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_approbation" class="form-control"  placeholder="">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div id="date_arretexploitation" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" class="form-control" name="adte_arret_exploitation"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_certficat" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_certficat" class="form-control"  placeholder="">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div id="date_projetexploitation" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_arreteregularisation" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_autorisation" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_autorisation" class="form-control"  placeholder="">
                                        </div>
                                        ...
                                        <div id="date_raccordement" class="form-group col-md-3" >
                                            <label for="inputPassword4">التاريخ</label>
                                            <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_raccordement" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <br>
                                        ...
                                        <div class="form-row mb-4">
                                                <div id="date_lancement2" class="form-group col-md-3" >
                                                    ...
                                                    <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_lancement2" class="form-control"  placeholder="">
                                                </div>
                                        </div>
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-3">
                                            ...
                                            <div id="date_permisconstruction2" class="form-group col-md-3" >
                                                <label for="inputPassword4">التاريخ</label>
                                                <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" class="form-control" name="date_permis_construction2" placeholder="">
                                            </div>
                                            <div class="form-group col-md-3">
                                            ...
                                            <div id="date_arretcreation2" class="form-group col-md-3" >
                                                <label for="inputPassword4">التاريخ</label>
                                                <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" class="form-control" name="date_arret_creation2"  placeholder="">
                                            </div>
                                        </div>
                                    ...
                                    <h6>(البطاقة -03) في طور الانطلاق </h6>
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div id="date_permisconstruction3" class="form-group col-md-3" >
                                                <label for="inputPassword4">التاريخ</label>
                                                <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_permis_construction3" class="form-control"  placeholder="">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="inputState">قرار الانشاء</label>
                                            ...
                                            <div id="date_arretcreation3" class="form-group col-md-3" >
                                                <label for="inputPassword4">التاريخ</label>
                                                <input type="Date" max="<?php echo e(date('d-m-Y')); ?>" name="date_arret_creation3" class="form-control"  placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-row mb-4">
                                            <label for="inputEmail4">العراقيل التي تواجهها</label>
