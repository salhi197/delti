                                ...
                                <div class="container-fluid" id="fiche1">
                                    ...
                                    <div class="form-row mb-4">                                        
                                        ...
                                        <div id="date_projetexploitation" class="form-group col-md-3" >
                                            ...
                                            <input type="date" max="<?php echo e(date('Y-m-d')); ?>" name="date_projet_exploitation" class="form-control"  placeholder="">
                                        </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_permisconstruction" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_permis_construction" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_arretcreation" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_arret_creation" class="form-control"  placeholder="">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div id="date_approbation" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_approbation" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_arretexploitation" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="adte_arret_exploitation"  placeholder="">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div id="date_certficat" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_certficat" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div id="date_projetexploitation" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_arreteregularisation" class="form-control"  placeholder="">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div id="date_autorisation" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_autorisation" class="form-control"  placeholder="">
                                        </div>
                                        ...
                                        <div id="date_raccordement" class="form-group col-md-3" >
                                            <label for="inputPassword4">Date</label>
                                            <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_raccordement" class="form-control"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <br>
                                        ...
                                        <div class="form-row mb-4">
                                                <div id="date_lancement2" class="form-group col-md-3" >
                                                    ...
                                                    <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_lancement2" class="form-control"  placeholder="">
                                                </div>
                                        </div>
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-3">
                                            ...
                                            <div id="date_permisconstruction2" class="form-group col-md-3" >
                                                <label for="inputPassword4">Date</label>
                                                <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="date_permis_construction2" placeholder="">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="inputState">Arrêté de création</label>
                                            ...
                                            <div id="date_arretcreation2" class="form-group col-md-3" >
                                                <label for="inputPassword4">Date</label>
                                                <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="date_arret_creation2"  placeholder="">
                                            </div>
                                        </div>
                                    ...
                                    <h6>> Projet en voie de lancement (Fiche-03)</h6>
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div id="date_permisconstruction3" class="form-group col-md-3" >
                                                <label for="inputPassword4">Date</label>
                                                <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_permis_construction3" class="form-control"  placeholder="">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="inputState">Arrêté de création</label>
                                            ...
                                            <div id="date_arretcreation3" class="form-group col-md-3" >
                                                <label for="inputPassword4">Date</label>
                                                <input type="Date" max="<?php echo e(date('Y-m-d')); ?>" name="date_arret_creation3" class="form-control"  placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-row mb-4">
                                            <label for="inputEmail4">Contraintes rencontrées</label>
