...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="<?php echo e(asset('wassit/img/core-img/favicon.png')); ?>">

    <!-- Core Style CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('wassit/css/core-style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('wassit/style.css')); ?>">

    <!-- Responsive CSS -->
    <link href="<?php echo e(asset('wassit/css/responsive.css')); ?>" rel="stylesheet">
...
<body>
                ...
                <div class="col-12 h-100">
                    <div class="main-menu h-100">
                        <nav class="navbar h-100 navbar-expand-lg">
                            <!-- Logo Area  -->
                            <a class="navbar-brand" href="index.html"><img src="<?php echo e(asset('wassit/img/core-img/logo1.png')); ?>" alt="Logo"
                            ...
                            <div class="collapse navbar-collapse" id="studioMenu">
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo e(route('inscription')); ?>"
                                ...
                                Search btn
                                <div id="searchbtn">
                                    <img src="<?php echo e(asset('wassit/img/core-img/search.png')); ?>" alt="">
                                </div>
                                -->
                            </div>
                        </nav>
    ...
    <div class="social-sidebar-area bg-white">
        ...
        <div class="message-box">
            <a href="#" data-toggle="modal" data-target=".contact-modal-lg"><img src="<?php echo e(asset('wassit/img/core-img/user (2).png')); ?>" alt="">
            </a>
        </div>
    </div>
    ...
    <section class="welcome-area">
        <div class="carousel h-100 slide" data-ride="carousel" id="welcomeSlider">
            ...
            <div class="carousel-inner h-100">
                ...
                <div class="carousel-item h-100 bg-img active" style="background-image: url(<?php echo e(asset('wassit/img/bg-img/m1.jpg')); ?>);">
                ...
                <div class="carousel-item h-100 bg-img" style="background-image: url(<?php echo e(asset('wassit/img/bg-img/b3\ \(2\).jpg')); ?>);">
                    <div class="carousel-content h-100">
                        <div class="slide-text">
                            <span>01.</span>
                ...
                <div class="carousel-item h-100 bg-img" style="background-image: url(<?php echo e(asset('wassit/img/bg-img/est.jpg')); ?>);">
                    <div class="carousel-content h-100">
                        <div class="slide-text">
                            <span>02.</span>
                ...
                <div class="carousel-item h-100 bg-img" style="background-image: url(<?php echo e(asset('wassit/img/bg-img/b2\ \(2\).jpg')); ?>);">
                    <div class="carousel-content h-100">
                        <div class="slide-text">
                            <span>03.</span>
            ...
            <ol class="carousel-indicators">
                ...
                <li data-target="#welcomeSlider" data-slide-to="0" class="active bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/1.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="1" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/2.jpg')); ?>);"></li>
                ...
                <li data-target="#welcomeSlider" data-slide-to="3" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/4.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="4" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/5.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="5" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/6.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="6" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/7.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="7" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/8.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="8" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/9.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="9" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/10.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="10" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/11.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="11" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/12.jpg')); ?>);"></li>
                <li data-target="#welcomeSlider" data-slide-to="12" class="bg-img"
                    style="background-image: url(<?php echo e(asset('wassit/img/bg-img/13.jpg')); ?>);"></li>
            -->
            </ol>
        </div>
    </section>
                ...
                <div class="col-12 h-100">
                    <div class="footer-content h-100 d-md-flex align-items-center justify-content-between">
                        ...
                        <div class="single-footer-content">
                            <img src="<?php echo e(asset('wassit/img/core-img/location.png')); ?>" width="25px" alt="">
                            <a href="https://goo.gl/maps/3xPb1SR5i4fY4f2z9" target="_blank">Cité Chaabani, El-biar ,
                                Alger</a>
                        </div>
                        <!-- Single Footer Content -->
                        <div class="single-footer-content">
                            <img src="<?php echo e(asset('wassit/img/core-img/call.png')); ?>" width="25px" alt="">
                            <a href="tel:+213 21 48 82 21">021 48 82 21</a>
                        </div>
                        <div class="single-footer-content">
                            <img src="<?php echo e(asset('wassit/img/core-img/print.png')); ?>" width="25px" alt="">
                            <a href="tel:+213 21 48 83 91">021 48 83 91</a>
                        </div>
                        <!-- Single Footer Content -->
                        <div class="single-footer-content">
                            <img src="<?php echo e(asset('wassit/img/core-img/mail.png')); ?>" width="25px" alt="">
                            <a href="mailto:" mediateur@el-mouradia.dz" target="_blank">mediateur@el-mouradia.dz</a>
                        </div>
                        <div class="single-footer-content">
                            <img src="<?php echo e(asset('wassit/img/core-img/copyright1.png')); ?>" width="20px" alt="">
                            <a href="#">
    ...
    <script src="<?php echo e(asset('wassit/js/jquery/jquery-2.2.4.min.js')); ?>"></script>
    <!-- Popper js -->
    <script src="<?php echo e(asset('wassit/js/popper.min.js')); ?>"></script>
    <!-- Bootstrap js -->
    <script src="<?php echo e(asset('wassit/js/bootstrap.min.js')); ?>"></script>
    <!-- Plugins js -->
    <script src="<?php echo e(asset('wassit/js/plugins.js')); ?>"></script>
    <!-- Active js -->
    <script src="<?php echo e(asset('wassit/js/active.js')); ?>"></script>
