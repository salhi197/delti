                                ...
                                <!-- Tab panes -->
                                                <div class="tab-content p-3 text-muted">
                                                    <div class="tab-pane active" id="home-1" role="tabpanel">
                                                        <form method="POST" action="<?php echo e(route('client.store.citoyen')); ?>" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input name="date_naissance_c" type="number" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="validationCustom05"
                                                                                    required>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input name="date_naissance_c" type="date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="validationCustom05"
                                                                                    required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input name="date_delivrance_c" type="date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="validationCustom05">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <div class="mb-3">
                                                                                <label for="validationCustom05" class="form-label">Date de Naissance *</label>
                                                                                <input name="date_naissance_op" type="date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="validationCustom05"
                                                                                    required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="mb-3">
                                                                                <label for="validationCustom05" class="form-label">Date de Délivrance</label>
                                                                                <input name="date_delivrance_op" type="date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="validationCustom05">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <div class="mb-3">
                                                                                <label for="validationCustom05" class="form-label">Date de Naissance *</label>
                                                                                <input name="date_naissance_a" type="date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="validationCustom05"
                                                                                    required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="mb-3">
                                                                                <label for="validationCustom05" class="form-label">Date de Délivrance</label>
                                                                                <input name="date_delivrance_a" type="date" max="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="validationCustom05">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- <div class="col-md-4">
