                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        <div class="tab-pane <?php if($client->type=="citoyen"): ?> active selected <?php endif; ?>" id="home12" role="tabpanel">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <hr>
                                                            <br>
                                                            <form class="needs-validation" method="post"  action="<?php echo e(route('client.update.citoyen',['client'=>$client->id])); ?>" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
                                        ...
                                        <div class="tab-pane <?php if($client->type=="association"): ?> active selected <?php endif; ?>" id="profile12" role="tabpanel">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <hr>
                                                            <br>
                                                            <form class="needs-validation" method="post"  action="<?php echo e(route('client.update.association',['client'=>$client->id])); ?>" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
                                        ...
                                        <div class="tab-pane <?php if($client->type=="operateur"): ?> active selected <?php endif; ?>" id="messages12" role="tabpanel">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <hr>
                                                            <br>
                                                            <form class="needs-validation" method="post"  action="<?php echo e(route('client.update.operateur',['client'=>$client->id])); ?>" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
