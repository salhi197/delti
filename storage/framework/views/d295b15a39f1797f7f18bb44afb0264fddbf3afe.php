          ...
          <form class="needs-validation" novalidate>
            ...
            <div class="row">
              <div class="form-group col-md-3">
                ...
                <input value="<?php echo e($investissement->telephone ?? ''); ?>" name="telephone" onKeyPress="if(this.value.length==9) return false" type="number"
                  class="form-control" id="inputEmail4" placeholder="">
              </div>
              <div class="form-group col-md-3">
                <label for="inputPassword4">Fax</label>
                <input value="<?php echo e($investissement->fax ?? ''); ?>" name="fax" type="number" onKeyPress="if(this.value.length==9) return false" class="form-control"
                  id="inputPassword4" placeholder="">
              </div>
              <div class="form-group col-md-3">
                <label for="inputPassword4">Mobile</label>
                <input value="<?php echo e($investissement->mobile ?? ''); ?>" name="mobile" type="number" onKeyPress="if(this.value.length==10) return false"
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="mb-3">
                  ...
                  <select value="<?php echo e($investissement->secteur ?? ''); ?>" name="secteur" class="form-control select2" id="inputState" required>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  ...
                  <input value="<?php echo e($investissement->activite ?? ''); ?>" name="activite" type="text" class="form-control" id="validationCustom05" required />
                </div>
              </div>
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="validationCustom02" class="form-label">Implimentation</label>
                  <select value="<?php echo e($investissement->implimentation ?? ''); ?>" name="implimentation" class="form-control select2" id="validationCustom03" required>
                    <option selected>Sélectionner...</option>
              ...
              <div class="col-md-3">
                <div class="mb-3">
                  ...
                  <input value="<?php echo e($investissement->Superficie ?? ''); ?>" name="Superficie" type="number" class="form-control" id="validationCustom05" required />
                </div>
                <br />
              </div>
            </div>
            ...
            <div class="row" id="fiche1">
              <div class="col-md-4">
                ...
                <div class="mb-3">
                  ...
                  <select value="<?php echo e($investissement->projet_exploitation ?? ''); ?>" name="projet_exploitation" id="projet_exploitation" class="form-control">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="date" max="<?php echo e(date('Y-m-d')); ?>" value="<?php echo e($investissement->date_projet_exploitation ?? ''); ?>" name="date_projet_exploitation" class="form-control"
                    placeholder="">
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="number" value="<?php echo e($investissement->emploi_cre ?? ''); ?>" name="emploi_cre" class="form-control" placeholder="">
                </div>
              </div>
              <div class="row">
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <select value="<?php echo e($investissement->permis_construction ?? ''); ?>" name="permis_construction" class="form-control" id="permis_construction" class="form-control">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <select value="<?php echo e($investissement->approbation ?? ''); ?>" name="approbation" class="form-control" id="approbation" class="form-control">
                      <option value="c">Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
                ...
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <select value="<?php echo e($investissement->arret_exploitation ?? ''); ?>" name="arret_exploitation" id="arret_exploitation" class="form-control">
                      <option value="c" selected>Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <select value="<?php echo e($investissement->certficat ?? ''); ?>" name="certficat" class="form-control" id="certficat" class="form-control">
                      <option value="c">Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
                ...
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <select value="<?php echo e($investissement->arreteregularisation ?? ''); ?>" name="arreteregularisation" id="arreteregularisation" class="form-control">
                      <option value="c" selected>Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <select value="<?php echo e($investissement->autorisation ?? ''); ?>" name="autorisation" class="form-control" id="autorisation" class="form-control">
                      <option value="c">Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
                ...
                <div class="col-md-3">
                  <div class="mb-3">
                    ...
                    <select value="<?php echo e($investissement->raccordement ?? ''); ?>" name="raccordement" class="form-control" id="raccordement" class="form-control">
                      <option value="c">Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
            ...
            <div class="row" id="fiche2">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="mb-3">
                    <label for="inputState">Permis de construire</label>
                    <select value="<?php echo e($investissement->permis_construction2 ?? ''); ?>" name="permis_construction2" id="permis_construction2" class="form-control">
                      <option value="c" selected>Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
                ...
                <div class="col-md-3">
                  <div class="mb-3">
                    <label for="inputState">Arrêté de création</label>
                    <select value="<?php echo e($investissement->arret_creation2 ?? ''); ?>" name="arret_creation2" class="form-control" id="arret_creation2" alue)" class="form-control">
                      <option value="c">Choisir</option>
                      <option value="o">Oui</option>
                      <option value="n">Non</option>
                    </select>
