                                        ...
                                        <div class="modal fade" id="firstmodal" aria-hidden="true" aria-labelledby="..."
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo e(route('fichier.store')); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" name="doleance_id" value="<?php echo e($doleance->id); ?>">
                                        ...
                                        <div class="modal fade" id="firstmodal2" aria-hidden="true" aria-labelledby="..."
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo e(route('doleance.retirer')); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" name="doleance_id" value="<?php echo e($doleance->id); ?>">
                                        ...
                                        <div class="col-12">
                                            <div class="invoice-title">
                                                <h4 class="float-end font-size-16"
                                                    ...
                                                    <strong><?php echo e($doleance->code_initial ?? ''); ?></strong>
                                                </h4>
                                                <h3>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <address>
                                                        <strong>Wilaya :<?php echo e($doleance->getElt('wilaya')); ?></strong><br>
                                                        Daira :<?php echo e($doleance->getElt('daira')); ?><br>
                                                        Commune : <?php echo e($doleance->getElt('commune')); ?><br>
                                                        Type de doleance : <?php echo e($doleance->getElt('typedoleance')); ?><br>
                                                        Secteur ou entité concernée par la requête :<?php echo e($doleance->getElt('secteur')); ?><br>
                                                        Organisme concerné :<?php echo e($doleance->getElt('wilaya')); ?><br>
                                                        Titre de la pétition :<?php echo e($doleance->getElt('sujet')); ?><br><br>
                                                        Lien vidéo :<?php echo e($doleance->video ?? ''); ?>

                                                    </address>

                                                </div>
                                                <div class="col-6 text-end">
                                                    <textarea class="form-control"><?php echo e($doleance->description ?? ''); ?></textarea>
                                                </div>
                                            </div>
