...
class ReclamationController extends Controller
{
    ...
    {
        $reclamations = Reclamation::where('user',Auth::user()->id)->get();
    ...
    public function create()
    {
        ...
        return view('reclamations.create',compact('wilayas','communes','dairas','typerequetes'));//c,compact('categories','settings'));
    }
