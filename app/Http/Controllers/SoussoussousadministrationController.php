...
class SoussousadministrationController extends Controller
{
    ...
    {
        $soussoussousadministrations = Soussousadministration::all();
        $administrations = administration::all();
        $sousadministrations = Sousadministration::all();
        return view('soussoussousadministrations.index',compact('administrations','soussousadministrations','sousadministrations'));
    }

    public function store(Request $request)
    {
        // dd($request['administration']);
        $soussoussousadministration = new Soussousadministration([
            'label' => $request['label'],
